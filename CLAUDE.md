...
Guide Claude Code (claude.ai/code) work this repo.
...
via `caveman-init`: terse, fragment-heavy chat responses, no
...
applies to conversational responses only, not anything persisted into
repo or git history.